...
const TileComponent: React.FC<TileProps> = ({ letter, status, isSubmitted, index, isCurrentRow }) => {
    ...
    return (
        <div
            className={`w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 border-2 flex items-center justify-center text-2xl sm:text-3xl md:text-4xl font-bold uppercase ${statusClasses[status]} ${animationClass} ${hintClass}`}
